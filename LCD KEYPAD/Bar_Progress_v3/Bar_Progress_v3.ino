 ...
 * Usa todos os caracteres personalizados de 0 a 8.
 */
...
void draw_progressbar(byte percent) {
  ...
  /* Mapeie o intervalo (0 ~ 100) para o intervalo (0 ~ LCD_NB_COLUMNS * 2 * 4 - 2 * 4) */
  ...
  for (byte i = 0; i < LCD_NB_COLUMNS; ++i) {
    ...
    if (i == 0) { // Premiére case
      ...
      /* Mostra o caractere final com base no número de colunas */
      if (nb_columns > 0) {
...
/**
 * Função de configuração dinâmica da tela LCD para a barra de progresso.
 *
 * @param bank O número do banco de caracteres para configurar.
 */
void switch_progressbar_bank(byte bank) {
  ...
  /* Mudança do banco de caracteres */
  switch (bank) {
    case 0:
