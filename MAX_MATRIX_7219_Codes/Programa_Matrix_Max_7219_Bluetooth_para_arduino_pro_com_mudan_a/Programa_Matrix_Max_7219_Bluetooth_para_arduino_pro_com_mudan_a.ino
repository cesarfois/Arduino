...
int data = 9;    // DIN pin del modulo MAX7219
int load = 8;    // CS pin del modulo MAX7219
int clock = 7;  // CLK pin del modulo MAX7219 
...
char mensaje1[] = " ENVIE A MENSAGENS "; //Escriba el mensaje a desplegar 
//char mensaje2[] =" TECNOLOGIA  ";
//char mensaje3[] =" ---  ";

void setup(){
  pinMode(9,OUTPUT);       //Conexion a DIN
  pinMode(8,OUTPUT);       //Conexion a CS
  pinMode(7,OUTPUT);      //Conexion a CLK
...
void loop(){
  ...
  delay(50);                 // Tiempo de inicio de un nuevo Ciclo de mensajes
